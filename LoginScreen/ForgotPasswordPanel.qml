...
Item {
    ...
    objectName: "ForgotPasswordPanel"
    ...
    StackView {
        ...
        initialItem: EnterYourEmailPage {
            id: enterYourEmailPage
    ...
    QtObject {
        ...
        property var pageList: ["EnterYourEmailPage", "OTPVerificationPage", "ResetPasswordPage", "PasswordResetSuccessPage"]
